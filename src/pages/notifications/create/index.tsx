...
function NotificationsCreatePage() {
  ...
  const formik = useFormik<NotificationsInterface>({
    initialValues: {
      ...
      read_at: new Date(new Date().toDateString()),
      user_id: '',
    },
    ...
    <AppLayout>
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="read_at" mb="4">
            <FormLabel>read_at</FormLabel>
            <DatePicker
              dateFormat={'dd/MM/yyyy'}
              selected={formik.values.read_at}
              onChange={(value: Date) => formik.setFieldValue('read_at', value)}
            />
          </FormControl>
